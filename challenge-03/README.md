...
*/
var pessoa = {nome: 'Guilherme', sobrenome: 'Silva', sexo:'masculino', idade: 30, altura: 1.80, peso: 72, andando: false, caminhouQuantosMetros: 0};
/*
...
*/
pessoa.nomeCompleto();//Olá! Meu nome é Guilherme Silva!'
...
// Agora, apresente-se ;)
pessoa.apresentacao(); // Olá, eu sou o Guilherme Silva, tenho 33 anos, 1.8. , meu peso é 72 e, só hoje,  eu já caminhei 200 metros!
```
